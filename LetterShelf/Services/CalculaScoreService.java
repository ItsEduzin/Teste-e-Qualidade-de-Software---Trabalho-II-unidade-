...
public class CalculaScoreService {
    ...
    public Map<Filme,ScoreFilme> definirScores(Usuario user, List<Filme> filmes, Map<Filme, ScoreFilme> relacaoFilmeScore){
    ...
    private double definirScoreDuracao(Usuario user, Filme filme){
        ...
        int abs=Math.min(Math.abs(perfil.getDuracaoMin()-filme.getDuracao()), Math.abs(perfil.getDuracaoMax()-filme.getDuracao()));
